      ...
      child: BlocListener<SignInBloc, SignInState>(
        listener: (context, state) {
          ...
          if (state is SignInSuccess) {
            // Перенаправлення на головний екран після успішної авторизації
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => Home()), // Замінити на ваш головний екран
            );
                        ...
                        child: BlocConsumer<GoogleAuthBloc, GoogleAuthState>(
                          listener: (context, state) {
                            if (state is GoogleAuthFailure) {
                              ...
                              // Перенаправлення після успішної авторизації через Google
                              Navigator.pushReplacement(
                                context,
